<?php
/**
 * Template Name: Deferred Lottie Performance Test
 * Description: Exact Tipalti Finance AI replica - Deferred Local mode
 */

get_header(); ?>

<div class="performance-mode-indicator defer">Deferred Local Mode</div>
