 ...
 * Description: Step 5 + Conditional enqueue (per-page)
 */
...
<div class="container">
    <div class="test-header">
        <h1>Step 6: Conditional Enqueue (Per-Page)</h1>
        <p class="test-description">All optimizations + conditional script loading only on Lottie pages</p>
