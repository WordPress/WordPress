<?php
/**
 * Template Name: Step 3 - Defer Test
 * Description: Local player + Canvas + Deferred/Async load method
 */
...
<div class="container">
    <div class="test-header">
        <h1>Step 3: Local Player + Canvas + Deferred/Async Load</h1>
        <p class="test-description">Canvas renderer with deferred script loading for better performance</p>
    ...
    <div class="test-info">
        ...
        <ul>
            ...
            <li><strong>Loading Strategy:</strong> Deferred/Async</li>
