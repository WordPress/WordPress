<?php
/**
 * Template Name: Lazy Loading Performance Test
 * 
 * This template displays the Tipalti Finance AI replica with Lazy Loading Lottie integration
 */
    ...
    <section id="test-info" style="padding: 2rem 0; background: var(--secondary-color);">
        <div class="container">
            <div style="text-align: center; padding: 1rem; background: white; border-radius: 8px; box-shadow: var(--shadow);">
                <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">🎯 Lazy Loading Performance Test</h3>
                <p style="color: var(--text-secondary); margin-bottom: 1rem;">This page uses Lazy Loading strategy - Lottie animations load only when entering viewport</p>
                <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                    <span><strong>Expected Score:</strong> ≥95</span>
                    <span><strong>Strategy:</strong> Intersection Observer</span>
                    <span><strong>Load Time:</strong> On viewport entry</span>
                </div>
            </div>
        </div>
    </section>
