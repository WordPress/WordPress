<?php
/**
 * Template Name: Global Lottie Performance Test
 * Description: Exact Tipalti Finance AI replica - Global CDN mode
 */

get_header(); ?>

<div class="performance-mode-indicator global">Global CDN Mode</div>
