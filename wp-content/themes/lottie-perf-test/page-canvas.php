<?php
/**
 * Template Name: Canvas Lottie Performance Test
 * Description: Exact Tipalti Finance AI replica - Canvas Renderer mode
 */

get_header(); ?>

<div class="performance-mode-indicator canvas">Canvas Renderer Mode</div>
