<?php
/**
 * Template Name: Step 5 - Cache Test
 * Description: Step 4 + Asset compression & caching (Brotli + Cache-Control)
 */
...
<div class="container">
    <div class="test-header">
        <h1>Step 5: Compression & Caching Optimization</h1>
        <p class="test-description">Lazy loading + Canvas + Asset compression & caching headers</p>
    ...
    <div class="test-info">
        ...
        <ul>
            ...
            <li><strong>Caching:</strong> Brotli compression + Cache-Control headers</li>
            <li><strong>Lazy Loading:</strong> IntersectionObserver API</li>
            <li><strong>Compression:</strong> Gzip/Brotli enabled</li>
        </ul>
    </div>
</div>
