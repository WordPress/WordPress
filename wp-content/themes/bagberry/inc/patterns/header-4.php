...
return array(
	'name' => 'header-4',
	'title' => 'Header with Background 2',
	'blockTypes' => array( 'core/template-part/header' ),
	'content' => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"accent-background","className":"header-additional","layout":{"type":"constrained"}} -->
    <div class="wp-block-group header-additional has-accent-background-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"className":"hide-on-mobile","layout":{"type":"constrained"}} -->
