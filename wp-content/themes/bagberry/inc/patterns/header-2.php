...
return array(
	'name' => 'header-2',
	'title' => 'Header with Transparent',
	'blockTypes' => array( 'core/template-part/header' ),
	'content' => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"accent","className":"has-transparent-header","layout":{"type":"constrained"}} -->
    <div class="wp-block-group has-transparent-header has-accent-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"className":"hide-on-mobile","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33%"><!-- wp:image {"id":224,"width":100,"height":26,"sizeSlug":"full","linkDestination":"custom"} -->
    <figure class="wp-block-image size-full is-resized"><a href="/"><img src="https://storage.googleapis.com/agni_patterns_bucket/bagberry/logo-lite.png" alt="" class="wp-image-224" width="100" height="26"/></a></figure>
    <!-- /wp:image --></div>
    <!-- /wp:column -->
    
    <!-- wp:column {"verticalAlignment":"center","width":"34%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:34%"><!-- wp:navigation {"ref":16,"textColor":"white","overlayMenu":"never","overlayTextColor":"primary","layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"},"typography":{"letterSpacing":"-0.015em"}},"fontSize":"medium"} /--></div>
    <!-- /wp:column -->
    ...
    <div class="wp-block-group"><!-- wp:image {"id":221,"width":25,"height":24,"sizeSlug":"full","linkDestination":"custom"} -->
    <figure class="wp-block-image size-full is-resized"><a href="/my-account/"><img src="https://storage.googleapis.com/agni_patterns_bucket/bagberry/myaccount-lite.png" alt="" class="wp-image-221" width="25" height="24"/></a></figure>
    <!-- /wp:image -->
    ...
    <div class="wp-block-group"><!-- wp:image {"id":224,"width":100,"height":26,"sizeSlug":"full","linkDestination":"custom"} -->
    <figure class="wp-block-image size-full is-resized"><a href="/"><img src="https://storage.googleapis.com/agni_patterns_bucket/bagberry/logo-lite.png" alt="" class="wp-image-224" width="100" height="26"/></a></figure>
    <!-- /wp:image --></div>
    <!-- /wp:group -->
    
    <!-- wp:group {"layout":{"type":"constrained","contentSize":"360px"}} -->
    <div class="wp-block-group"><!-- wp:navigation {"ref":16,"textColor":"white","layout":{"type":"flex","justifyContent":"left"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"fontSize":"medium"} /--></div>
    <!-- /wp:group --></div>
    <!-- /wp:group --></div>
    <!-- /wp:column -->
