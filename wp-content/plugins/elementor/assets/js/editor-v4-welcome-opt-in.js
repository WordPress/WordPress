...
var WelcomeDialog = exports.WelcomeDialog = function WelcomeDialog(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Dialog, {
    ...
    variant: "h6",
    color: "text.primary"
  }, i18n.heading), /*#__PURE__*/_react.default.createElement(_ui.Box, null, /*#__PURE__*/_react.default.createElement(_ui.Typography, {
    variant: "body1",
    color: "text.secondary"
  }, i18n.introduction), /*#__PURE__*/_react.default.createElement(_ui.List, {
    sx: {
      pl: 2
    }
  }, i18n.listItems.map(function (text, index) {
    ...
    variant: "body1",
    color: "text.secondary"
  }, i18n.footerText), /*#__PURE__*/_react.default.createElement(_ui.Link, {
    href: contentLinks.helpCenter,
    target: "_blank",
    variant: "body1",
    color: "info.main",
    sx: {
  ...
  }, i18n.helpCenter))), /*#__PURE__*/_react.default.createElement(_ui.Divider, null), /*#__PURE__*/_react.default.createElement(_ui.Stack, {
    py: 2,
    px: 3
...
var _ui = __webpack_require__(/*! @elementor/ui */ "@elementor/ui");
var _welcomeDialog = __webpack_require__(/*! ./welcome-dialog */ "../modules/atomic-opt-in/assets/js/welcome-screen/welcome-dialog.js");
function _interopRequireWildcard(e, t) { if ("function" == typeof WeakMap) var r = new WeakMap(), n = new WeakMap(); return (_interopRequireWildcard = function _interopRequireWildcard(e, t) { if (!t && e && e.__esModule) return e; var o, i, f = { __proto__: null, default: e }; if (null === e || "object" != _typeof(e) && "function" != typeof e) return f; if (o = t ? n : r) { if (o.has(e)) return o.get(e); o.set(e, f); } for (var _t in e) "default" !== _t && {}.hasOwnProperty.call(e, _t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, _t)) && (i.get || i.set) ? o(f, _t, i) : f[_t] = e[_t]); return f; })(e, t); }
var App = function App(props) {
  var _useState = (0, _react.useState)(true),
    _useState2 = (0, _slicedToArray2.default)(_useState, 2),
    isWelcomeVisible = _useState2[0],
    setIsWelcomeVisible = _useState2[1];
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.DirectionProvider, {
    ...
    colorScheme: 'light',
    palette: "unstable"
  }, isWelcomeVisible && /*#__PURE__*/_react.default.createElement(_welcomeDialog.WelcomeDialog, {
    doClose: handleClose
  }))));
};
App.propTypes = {
...
var getRootElement = function getRootElement() {
  var popoverRoot = document.querySelector('#e-v4-opt-in-welcome');
  if (!popoverRoot) {
...
/******/ })()
;
//# sourceMappingURL=editor-v4-welcome-opt-in.js.map