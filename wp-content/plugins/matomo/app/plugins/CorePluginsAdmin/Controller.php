...
class Controller extends Plugin\ControllerAdmin
{
    ...
    private function dieIfPluginsAdminIsDisabled()
    {
        ...
        if (!\Piwik\Plugins\CorePluginsAdmin\CorePluginsAdmin::isPluginsAdminEnabled()) {
    ...
    private function createPluginsOrThemesView($template, $themesOnly)
    {
        ...
        $view->isPluginUploadEnabled = \Piwik\Plugins\CorePluginsAdmin\CorePluginsAdmin::isPluginUploadEnabled();
