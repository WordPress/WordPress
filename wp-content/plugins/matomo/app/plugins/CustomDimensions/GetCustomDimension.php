...
class GetCustomDimension extends Report
{
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        } elseif ($this->scopeOfDimension === \Piwik\Plugins\CustomDimensions\CustomDimensions::SCOPE_ACTION) {
    ...
    public function getMetrics()
    {
        ...
        if ($this->scopeOfDimension === \Piwik\Plugins\CustomDimensions\CustomDimensions::SCOPE_ACTION) {
