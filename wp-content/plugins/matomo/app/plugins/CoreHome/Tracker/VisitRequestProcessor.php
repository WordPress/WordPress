...
class VisitRequestProcessor extends RequestProcessor
{
    ...
    public function __construct(EventDispatcher $eventDispatcher, VisitorRecognizer $visitorRecognizer, Settings $userSettings, $visitStandardLength, $trackerAlwaysNewVisitor)
    {
