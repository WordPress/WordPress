...
class Engagement extends RecordBuilder
{
    ...
    {
        return [Record::make(Record::TYPE_BLOB, Archiver::TIME_SPENT_RECORD_NAME), Record::make(Record::TYPE_BLOB, Archiver::PAGES_VIEWED_RECORD_NAME), Record::make(Record::TYPE_BLOB, Archiver::VISITS_COUNT_RECORD_NAME), Record::make(Record::TYPE_BLOB, Archiver::DAYS_SINCE_LAST_RECORD_NAME)];
    }
    protected function aggregate(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        $prefixes = [Archiver::TIME_SPENT_RECORD_NAME => 'tg', Archiver::PAGES_VIEWED_RECORD_NAME => 'pg', Archiver::VISITS_COUNT_RECORD_NAME => 'vbvn', Archiver::DAYS_SINCE_LAST_RECORD_NAME => 'dslv'];
