...
class ServerTime extends \Piwik\Plugins\VisitTime\RecordBuilders\Base
{
    public function getRecordMetadata(ArchiveProcessor $archiveProcessor) : array
    {
        return [Record::make(Record::TYPE_BLOB, Archiver::SERVER_TIME_RECORD_NAME)];
    }
    protected function aggregate(ArchiveProcessor $archiveProcessor) : array
    {
        ...
        while ($conversionRow = $query->fetch()) {
            ...
            $columns = [Metrics::INDEX_GOALS => [$idGoal => Metrics::makeGoalColumnsRow($idGoal, $conversionRow)]];
        ...
        return [Archiver::SERVER_TIME_RECORD_NAME => $record];
    }
