...
class StackedBarEvolution extends JqplotDataGenerator\Evolution
{
    ...
    {
        $visualization = new \Piwik\Plugins\PagePerformance\JqplotDataGenerator\Chart();
    ...
    protected function initChartObjectData($dataTable, $visualization)
    {
        ...
        foreach ($columnsToDisplay as $columnName) {
            $seriesMetadata[$columnName] = ['internalLabel' => $columnName, 'label' => @$this->properties['translations'][$columnName] ?: $columnName];
        }
