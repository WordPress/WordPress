...
return [
     ...
     */
    'featureflag.storages' => [DI::get('Piwik\\Plugins\\FeatureFlags\\Storage\\ConfigFeatureFlagStorage')],
    /**
    ...
    FeatureFlagManager::class => DI::autowire()->constructor(DI::get('featureflag.storages'), DI::get(Logger::class)),
];
