 ...
 */
class JsTestPluginTrackerFiles extends \Piwik\Plugins\CustomJsTracker\TrackingCode\PluginTrackerFiles
{
    ...
    protected function getDirectoriesToLook()
    {
        ...
        foreach ($trackerFiles as $trackerFile) {
            ...
            if ($pluginName === 'PrivacyManager') {
                continue;
                // ignore tracker.js of PrivacyManager, as it would disable Cookies
            }
