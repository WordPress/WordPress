...
class ClickHtmlAttributeVariable extends \Piwik\Plugins\TagManager\Template\Variable\BaseVariable
{
    ...
    {
        return array($this->makeSetting('htmlAttribute', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
