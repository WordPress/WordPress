...
class CookieYesTag extends \Piwik\Plugins\TagManager\Template\Tag\BaseTag
{
    ...
    {
        return array($this->makeSetting('cookieYesWebsiteKey', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
            $field->title = Piwik::translate('TagManager_CookieYesTagWebsiteKeyTitle');
            $field->inlineHelp = Piwik::translate('TagManager_CookieYesTagWebsiteKeyDescription', ['<strong>', '</strong>']);
