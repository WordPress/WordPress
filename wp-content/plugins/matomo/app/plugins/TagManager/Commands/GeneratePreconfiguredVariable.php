...
class GeneratePreconfiguredVariable extends GeneratePluginBase
{
    ...
    protected function doExecute() : int
    {
        ...
        $replace = array('TagManager' => $pluginName, 'Weekday' => $variableId, 'use Piwik\\Plugins\\' . $pluginName => 'use Piwik\\Plugins\\TagManager');
        $whitelistFiles = array('/Template', '/Template/Variable', '/Template/Variable/PreConfigured', '/Template/Variable/PreConfigured/WeekdayVariable.php');
        ...
        $this->writeSuccessMessage(array(sprintf('Variable for %s in folder "plugins/%s/Template/Variable/Preconfigured" generated.', $pluginName, $pluginName), 'You can now start implementing the preconfigured variable', 'Enjoy!'));
        return self::SUCCESS;
    }
    /**
     * @return string
