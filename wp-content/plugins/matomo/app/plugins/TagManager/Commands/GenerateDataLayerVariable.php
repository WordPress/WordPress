...
class GenerateDataLayerVariable extends GeneratePluginBase
{
    ...
    protected function doExecute() : int
    {
        ...
        $replace = array('TagManager' => $pluginName, 'ClickId' => $variableId);
        $whitelistFiles = array('/Template', '/Template/Variable', '/Template/Variable/PreConfigured', '/Template/Variable/PreConfigured/ClickIdVariable.php', 'use Piwik\\Plugins\\' . $pluginName => 'use Piwik\\Plugins\\TagManager');
        ...
        $this->writeSuccessMessage(array(sprintf('Variable for %s in folder "plugins/%s/Template/Variable/Preconfigured" generated.', $pluginName, $pluginName), 'You can now start implementing the preconfigured data layer variable', 'Enjoy!'));
        return self::SUCCESS;
    }
    /**
     * @return string
