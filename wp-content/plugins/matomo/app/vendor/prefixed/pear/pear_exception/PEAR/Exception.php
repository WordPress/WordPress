...
class PEAR_Exception extends \Exception
{
    ...
    public function __construct($message, $p2 = null, $p3 = null)
    {
        if (\is_int($p2)) {
            ...
            if (\is_object($p2) && !$p2 instanceof \Exception) {
                if (!\class_exists('Matomo\\Dependencies\\PEAR_Error') || !$p2 instanceof PEAR_Error) {
        ...
        foreach (self::$_observers as $func) {
            ...
            switch ($func[0]) {
                ...
                case self::OBSERVER_TRIGGER:
                    ...
                    \trigger_error($this->getMessage(), $f);
                    break;
                case self::OBSERVER_DIE:
                    ...
                    break;
                default:
                    \trigger_error('invalid observer type', \E_USER_WARNING);
            }
        }
    }
    /**
    ...
    public function getCauseMessage(&$causes)
    {
        ...
        $cause = array('class' => \get_class($this), 'message' => $this->message, 'file' => 'unknown', 'line' => 'unknown');
        if (isset($trace[0])) {
        ...
        if ($this->cause instanceof PEAR_Exception) {
        ...
        } elseif (\class_exists('Matomo\\Dependencies\\PEAR_Error') && $this->cause instanceof PEAR_Error) {
            $causes[] = array('class' => \get_class($this->cause), 'message' => $this->cause->getMessage(), 'file' => 'unknown', 'line' => 'unknown');
            ...
            foreach ($this->cause as $cause) {
                ...
                } elseif (\class_exists('Matomo\\Dependencies\\PEAR_Error') && $cause instanceof PEAR_Error) {
                    $causes[] = array('class' => \get_class($cause), 'message' => $cause->getMessage(), 'file' => 'unknown', 'line' => 'unknown');
