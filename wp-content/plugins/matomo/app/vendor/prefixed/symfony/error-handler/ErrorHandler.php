 ...
 */
namespace Matomo\Dependencies\Symfony\Component\ErrorHandler;

use Matomo\Dependencies\Psr\Log\LoggerInterface;
use Matomo\Dependencies\Psr\Log\LogLevel;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\Error\FatalError;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\Error\OutOfMemoryError;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorEnhancer\ClassNotFoundErrorEnhancer;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedMethodErrorEnhancer;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorRenderer\CliErrorRenderer;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer;
use Matomo\Dependencies\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext;
/**
...
class ErrorHandler
{
    ...
    public function handleException(\Throwable $exception)
    {
        ...
        if ($this->loggedErrors & $type) {
            if (\false !== strpos($message = $exception->getMessage(), "@anonymous\x00")) {
                $message = $this->parseAnonymousClass($message);
            }
            if ($exception instanceof FatalError) {
