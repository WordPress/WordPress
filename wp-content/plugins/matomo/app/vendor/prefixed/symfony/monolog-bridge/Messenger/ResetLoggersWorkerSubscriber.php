 ...
 */
namespace Matomo\Dependencies\Symfony\Bridge\Monolog\Messenger;
...
class ResetLoggersWorkerSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [WorkerMessageHandledEvent::class => 'resetLoggers', WorkerMessageFailedEvent::class => 'resetLoggers'];
    }
