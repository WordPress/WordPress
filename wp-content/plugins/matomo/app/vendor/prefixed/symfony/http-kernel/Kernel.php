 ...
 */
namespace Matomo\Dependencies\Symfony\Component\HttpKernel;
...
use Matomo\Dependencies\Symfony\Component\ErrorHandler\DebugClassLoader;
...
use Matomo\Dependencies\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use Matomo\Dependencies\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use Matomo\Dependencies\Symfony\Component\HttpKernel\Config\FileLocator;
use Matomo\Dependencies\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use Matomo\Dependencies\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        $content = $dumper->dump(['class' => $class, 'base_class' => $baseClass, 'file' => $cache->getPath(), 'as_files' => \true, 'debug' => $this->debug, 'build_time' => $container->hasParameter('kernel.container_build_time') ? $container->getParameter('kernel.container_build_time') : time(), 'preload_classes' => array_map('get_class', $this->bundles)]);
