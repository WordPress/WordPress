        ...
        function list_runs()
        {
            if (\is_dir($this->dir)) {
                ...
                foreach ($files as $file) {
                    ...
                    echo '<li><a href="' . \htmlentities($_SERVER['SCRIPT_NAME']) . '?run=' . \htmlentities($run) . '&source=' . \htmlentities($source) . '">' . \htmlentities(\basename($file)) . "</a><small> " . \date("Y-m-d H:i:s", \filemtime($file)) . "</small></li>\n";
                }
                echo "</ul>\n";
            }
        }
