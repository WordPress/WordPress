...
namespace {
    ...
    class Zend_Db_Adapter_Pdo_Oci extends \Zend_Db_Adapter_Pdo_Abstract
    {
         ...
         */
        protected $_numericDataTypes = array(\Zend_Db::INT_TYPE => \Zend_Db::INT_TYPE, \Zend_Db::BIGINT_TYPE => \Zend_Db::BIGINT_TYPE, \Zend_Db::FLOAT_TYPE => \Zend_Db::FLOAT_TYPE, 'BINARY_DOUBLE' => \Zend_Db::FLOAT_TYPE, 'BINARY_FLOAT' => \Zend_Db::FLOAT_TYPE, 'NUMBER' => \Zend_Db::FLOAT_TYPE);
        /**
        ...
        {
            $this->_connect();
            $value = $this->fetchOne('SELECT ' . $this->quoteIdentifier($sequenceName, \true) . '.CURRVAL FROM dual');
            return $value;
        }
        /**
        ...
        {
            $this->_connect();
            $value = $this->fetchOne('SELECT ' . $this->quoteIdentifier($sequenceName, \true) . '.NEXTVAL FROM dual');
            return $value;
        }
        /**
