...
namespace {
    ...
    class Zend_Db_Adapter_Sqlsrv extends \Zend_Db_Adapter_Abstract
    {
         ...
         * @var array
         */
        protected $_config = array('dbname' => null, 'username' => null, 'password' => null);
        /**
        ...
        protected function _connect()
        {
            ...
            $connectionInfo = array('Database' => $this->_config['dbname']);
            if (isset($this->_config['username']) && isset($this->_config['password'])) {
                $connectionInfo += array('UID' => $this->_config['username'], 'PWD' => $this->_config['password']);
            }
        ...
        public function insert($table, array $bind)
        {
            ...
            foreach ($bind as $col => $val) {
                $cols[] = $this->quoteIdentifier($col, \true);
            ...
            // build the statement
            $sql = "INSERT INTO " . $this->quoteIdentifier($table, \true) . ' (' . \implode(', ', $cols) . ') ' . 'VALUES (' . \implode(', ', $vals) . ')' . ' ' . $this->_lastInsertSQL;
        ...
        public function describeTable($tableName, $schemaName = null)
        {
             ...
             */
            $sql = "exec sp_columns @table_name = " . $this->quoteIdentifier($tableName, \true);
            $stmt = $this->query($sql);
            ...
            $sql = "exec sp_pkeys @table_owner = " . $tableOwner . ", @table_name = " . $this->quoteIdentifier($tableName, \true);
            $stmt = $this->query($sql);
