...
namespace {
    ...
    class Zend_Db_Adapter_Pdo_Sqlite extends \Zend_Db_Adapter_Pdo_Abstract
    {
         ...
         */
        protected $_numericDataTypes = array(\Zend_Db::INT_TYPE => \Zend_Db::INT_TYPE, \Zend_Db::BIGINT_TYPE => \Zend_Db::BIGINT_TYPE, \Zend_Db::FLOAT_TYPE => \Zend_Db::FLOAT_TYPE, 'INTEGER' => \Zend_Db::BIGINT_TYPE, 'REAL' => \Zend_Db::FLOAT_TYPE);
        /**
         * Constructor.
         *
        ...
        public function describeTable($tableName, $schemaName = null)
        {
            ...
            foreach ($result as $key => $row) {
                list($length, $scale, $precision, $primary, $primaryPosition, $identity) = array(null, null, null, \false, null, \false);
