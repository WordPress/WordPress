...
namespace {
    ...
    abstract class Zend_Db_Adapter_Abstract
    {
         ...
         * @var bool
         */
        protected $_autoQuoteIdentifiers = \true;
        /**
         ...
         */
        protected $_numericDataTypes = array(\Zend_Db::INT_TYPE => \Zend_Db::INT_TYPE, \Zend_Db::BIGINT_TYPE => \Zend_Db::BIGINT_TYPE, \Zend_Db::FLOAT_TYPE => \Zend_Db::FLOAT_TYPE);
        /** Weither or not that object can get serialized
         *
         * @var bool
         */
        protected $_allowSerialization = \true;
        /**
        ...
        public function __construct($config)
        {
            ...
            $options = array(\Zend_Db::CASE_FOLDING => $this->_caseFolding, \Zend_Db::AUTO_QUOTE_IDENTIFIERS => $this->_autoQuoteIdentifiers, \Zend_Db::FETCH_MODE => $this->_fetchMode);
            $driverOptions = array();
            /*
        ...
        public function insert($table, array $bind)
        {
            ...
            // build the statement
            $sql = "INSERT INTO " . $this->quoteIdentifier($table, \true) . ' (' . \implode(', ', $cols) . ') ' . 'VALUES (' . \implode(', ', $vals) . ')';
        ...
        public function update($table, array $bind, $where = '')
        {
            ...
            foreach ($bind as $col => $val) {
                ...
                $set[] = $this->quoteIdentifier($col, \true) . ' = ' . $val;
            }
            $where = $this->_whereExpr($where);
            /**
             * Build the UPDATE statement
             */
            $sql = "UPDATE " . $this->quoteIdentifier($table, \true) . ' SET ' . \implode(', ', $set) . ($where ? " WHERE {$where}" : '');
            /**
             * Execute the statement and return the number of affected rows
             */
            if ($this->supportsParameters('positional')) {
        ...
        public function delete($table, $where = '')
        {
             ...
             */
            $sql = "DELETE FROM " . $this->quoteIdentifier($table, \true) . ($where ? " WHERE {$where}" : '');
            /**
             * Execute the statement and return the number of affected rows
             */
            $stmt = $this->query($sql);
        ...
        {
            if ($auto === \false || $this->_autoQuoteIdentifiers === \true) {
        ...
        {
            if ($this->_autoReconnectOnUnserialize == \true) {
                $this->getConnection();
            }
        }
        /**
         ...
         */
        protected abstract function _commit();
        /**
         * Roll-back a transaction.
         */
        protected abstract function _rollBack();
        /**
         * Set the fetch mode.
         *
         * @param integer $mode
