    ...
    class Zend_Db_Statement_Oracle extends \Zend_Db_Statement
    {
        ...
        public function errorInfo()
        {
            ...
            if (isset($error['sqltext'])) {
                return array($error['code'], $error['message'], $error['offset'], $error['sqltext']);
            } else {
        ...
        public function fetch($style = null, $cursor = null, $offset = null)
        {
            ...
            switch ($style) {
                ...
                default:
                     ...
                     */
                    // require_once 'Zend/Db/Statement/Oracle/Exception.php';
                    throw new \Zend_Db_Statement_Oracle_Exception(array('code' => 'HYC00', 'message' => "Invalid fetch mode '{$style}' specified"));
                    break;
            }
        ...
        public function fetchAll($style = null, $col = 0)
        {
            ...
            switch ($style) {
                case \Zend_Db::FETCH_BOTH:
                     ...
                     */
                    // require_once 'Zend/Db/Statement/Oracle/Exception.php';
                    throw new \Zend_Db_Statement_Oracle_Exception(array('code' => 'HYC00', 'message' => "OCI8 driver does not support fetchAll(FETCH_BOTH), use fetch() in a loop instead"));
                    // notreached
                    $flags |= \OCI_NUM;
                    $flags |= \OCI_ASSOC;
                    break;
        ...
        public function nextRowset()
        {
             ...
             */
            // require_once 'Zend/Db/Statement/Oracle/Exception.php';
            throw new \Zend_Db_Statement_Oracle_Exception(array('code' => 'HYC00', 'message' => 'Optional feature not implemented'));
        }
        /**
