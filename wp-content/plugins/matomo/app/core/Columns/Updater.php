...
class Updater extends \Piwik\Updates
{
    ...
    {
        return 0 === strpos($name, 'log_visit.') || 0 === strpos($name, 'log_conversion.') || 0 === strpos($name, 'log_conversion_item.') || 0 === strpos($name, 'log_link_visit_action.');
    }
