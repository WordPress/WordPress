...
namespace {
    ...
    if (!\function_exists('Piwik_GetErrorMessagePage')) {
        ...
        function Piwik_GetErrorMessagePage($message, $optionalTrace = \false, $optionalLinks = \false, $optionalLinkBack = \false, $logoUrl = \false, $faviconUrl = \false, $isCli = null, $errorLogPrefix = '', $writeErrorLog = \true, $redirectUrl = null, $countdown = null)
        {
            ...
            $backLinks = '<p>' . $optionalLinkBack . ' | <a href="index.php">Go to Matomo</a>' . '</p>';
            $redirectSection = '';
            ...
            $content = '<h2>' . $message . '</h2>' . $redirectSection . $backLinks . ' ' . (\Piwik_ShouldPrintBackTraceWithMessage() ? $optionalTrace : '') . ' ' . $optionalLinks;
    ...
    if (!empty($piwik_errorMessage)) {
        echo \Piwik_GetErrorMessagePage($piwik_errorMessage, \false, \true);
        exit(1);
    }
}
