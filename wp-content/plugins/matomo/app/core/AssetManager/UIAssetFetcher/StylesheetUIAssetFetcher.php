...
class StylesheetUIAssetFetcher extends UIAssetFetcher
{
    protected function getPriorityOrder()
    {
        ...
        $order = array(
            ...
            'node_modules/',
            'libs/',
            'plugins/CoreHome/stylesheets/color_manager.css',
            // must be before other Piwik stylesheets
        ...
        $order = array_merge($order, array('plugins/Dashboard/stylesheets/dashboard.less', 'tests/'));
        return $order;
    }
