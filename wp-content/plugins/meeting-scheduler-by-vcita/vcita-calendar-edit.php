...
<div class="vcita-wrap wide">
  <div id="vcita-head">
    Edit vCita Scheduling Calendar Widget
  ...
  <script type="text/html" id="iframe-template">
    <iframe src="http://<?php echo VCITA_SERVER_BASE ?>/widget_implementations?platform=wordpress&widget=scheduler&key=<?php echo $key ?>" width="100%" height="100%"/>
  </script>
  <?php } else { ?>
  <script type="text/javascript"> 
    jQuery(function ($) { 
