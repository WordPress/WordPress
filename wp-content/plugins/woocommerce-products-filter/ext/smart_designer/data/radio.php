    ...
    'sections' => [
        [
            ...
            'table' => [
                ...
                'rows' => [
                    'width' => [
                        ['value' => ['element' => 'ranger', 'value' => 19, 'min' => 10, 'max' => 500, 'conditions' => []], 'measure' => 'px'], //cell
                        ['value' => esc_html__('Min width', 'woocommerce-products-filter')] //cell
                    ],
                    'height' => [
                        ['value' => ['element' => 'ranger', 'value' => 19, 'min' => 10, 'max' => 500], 'measure' => 'px'], //cell
                        ['value' => esc_html__('Height', 'woocommerce-products-filter')] //cell
                    ],
                    'font_size' => [
                        ['value' => ['element' => 'ranger', 'value' => 14, 'min' => 8, 'max' => 72], 'measure' => 'px'], //cell
