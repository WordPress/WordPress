...
class WOOF_ACF_FILTER_SELECT extends WOOF_ACF_FILTER_TYPE {

    public $type = 'select';
    protected $js_func_name = "woof_init_acf_select";
    ...
    public function wp_footer() {
        wp_enqueue_script('acf-select-js', $this->get_meta_filter_link() . 'js/select.js', array('jquery'), WOOF_VERSION, true);
    }
