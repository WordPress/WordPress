...
<div data-css-class="woof_sku_search_container" class="woof_sku_search_container woof_container woof_container_woof_sku">
    ...
    <div class="woof_container_inner">
        ...
        <div class="woof_show_sku_search_container">
            ...
            <a href="javascript:void(0);" data-uid="<?php echo esc_attr($unique_id) ?>" class="woof_sku_search_reset <?php echo esc_attr($unique_id) ?>"><span class="dashicons dashicons-dismiss"></span></a>
            <input type="search" class="woof_show_sku_search <?php echo esc_attr($unique_id) ?>" id="<?php echo esc_attr($unique_id) ?>" data-uid="<?php echo esc_attr($unique_id) ?>" placeholder="<?php echo esc_attr(isset($placeholder) ? $placeholder : $p) ?>" name="woof_sku" value="<?php echo esc_attr($woof_sku) ?>" /><br />
