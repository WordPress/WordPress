 ...
 */
class Request implements \WPSentry\ScopedVendor\Psr\Http\Message\RequestInterface
{
    use MessageTrait;
    /** @var string */
    private $method;
    ...
    public function __construct(string $method, $uri, array $headers = [], $body = null, string $version = '1.1')
    {
        ...
        if ($body !== '' && $body !== null) {
            $this->stream = \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Utils::streamFor($body);
        }
    }
