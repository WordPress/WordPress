 ...
 */
class ServerRequest extends \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Request implements \WPSentry\ScopedVendor\Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    private static function createUploadedFileFromSpec(array $value)
    {
        ...
        return new \WPSentry\ScopedVendor\GuzzleHttp\Psr7\UploadedFile($value['tmp_name'], (int) $value['size'], (int) $value['error'], $value['name'], $value['type']);
    }
    /**
     ...
     */
    public static function getUriFromGlobals() : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
        $uri = new \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Uri('');
    ...
    public function withCookieParams(array $cookies) : \WPSentry\ScopedVendor\Psr\Http\Message\ServerRequestInterface
    {
        $new = clone $this;
    ...
    public function withQueryParams(array $query) : \WPSentry\ScopedVendor\Psr\Http\Message\ServerRequestInterface
    {
        $new = clone $this;
