 ...
 */
final class AppendStream implements \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
