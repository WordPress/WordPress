...
final class SentrySdk
{
     ...
     * gets called.
     */
    public static function init() : \Sentry\State\HubInterface
    {
        self::$currentHub = new \Sentry\State\Hub();
     ...
     */
    public static function getCurrentHub() : \Sentry\State\HubInterface
    {
     ...
     */
    public static function setCurrentHub(\Sentry\State\HubInterface $hub) : \Sentry\State\HubInterface
    {
        self::$currentHub = $hub;
        return $hub;
    }
