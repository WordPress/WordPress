...
final class CheckIn
{
     ...
     */
    public function __construct(string $monitorSlug, \Sentry\CheckInStatus $status, ?string $id = null, ?string $release = null, ?string $environment = null, $duration = null, ?\Sentry\MonitorConfig $monitorConfig = null)
    {
    ...
    public function setStatus(\Sentry\CheckInStatus $status) : self
    {
        $this->status = $status;
        return $this;
    }
    ...
    public function getMonitorConfig() : ?\Sentry\MonitorConfig
    {
        return $this->monitorConfig;
    }
    public function setMonitorConfig(?\Sentry\MonitorConfig $monitorConfig) : self
    {
