...
final class Profile
{
    ...
    public function __construct(?\Sentry\Options $options = null)
    {
        ...
        $this->logger = $options !== null ? $options->getLoggerOrNullLogger() : new \WPSentry\ScopedVendor\Psr\Log\NullLogger();
    }
