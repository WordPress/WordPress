...
class LogsHandler implements \Monolog\Handler\HandlerInterface
{
    ...
    {
        \Sentry\Logs\Logs::getInstance()->flush();
    }
    /**
    ...
    public function setFormatter(\Monolog\Formatter\FormatterInterface $formatter) : void
    {
