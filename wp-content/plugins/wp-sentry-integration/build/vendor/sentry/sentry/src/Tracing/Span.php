...
class Span
{
     ...
     */
    public function setSpanId(\Sentry\Tracing\SpanId $spanId) : self
    {
        $this->spanId = $spanId;
        return $this;
    }
     ...
     * @return $this
     */
    public function setTraceId(\Sentry\Tracing\TraceId $traceId)
    {
     ...
     * @return $this
     */
    public function setParentSpanId(?\Sentry\Tracing\SpanId $parentSpanId)
    {
     ...
     * @return $this
     */
    public function setStatus(?\Sentry\Tracing\SpanStatus $status)
    {
        $this->status = $status;
        return $this;
    }
