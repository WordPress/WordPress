...
final class Layer
{
     ...
     */
    public function __construct(?\Sentry\ClientInterface $client, \Sentry\State\Scope $scope)
    {
        $this->client = $client;
        $this->scope = $scope;
    }
     ...
     * @return $this
     */
    public function setClient(?\Sentry\ClientInterface $client) : self
    {
        $this->client = $client;
        return $this;
    }
     ...
     */
    public function getScope() : \Sentry\State\Scope
    {
        return $this->scope;
    }
    /**
     ...
     * @return $this
     */
    public function setScope(\Sentry\State\Scope $scope) : self
    {
        $this->scope = $scope;
        return $this;
    }
