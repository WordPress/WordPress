...
class AttributeBag
{
    ...
    {
        $attribute = $value instanceof \Sentry\Attributes\Attribute ? $value : \Sentry\Attributes\Attribute::tryFromValue($value);
        if ($attribute !== null) {
    ...
    {
        return \array_map(static function (\Sentry\Attributes\Attribute $attribute) {
