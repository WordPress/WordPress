 ...
 */
final class FrameContextifierIntegration implements \Sentry\Integration\IntegrationInterface
{
    /**
     ...
     */
    private function addContextToStacktraceFrames(int $maxContextLines, \Sentry\Stacktrace $stacktrace) : void
    {
     ...
     * @param int $maxContextLines The maximum number of lines of code to read
     */
    private function addContextToStacktraceFrame(int $maxContextLines, \Sentry\Frame $frame) : void
    {
    ...
    {
        $frame = ['pre_context' => [], 'context_line' => null, 'post_context' => []];
