 ...
 */
function gutenberg_render_block_core_video( array $attributes, string $content ): string {
 ...
 * @since 6.9.0
 */
function gutenberg_register_block_core_video(): void {
	register_block_type_from_metadata(
		__DIR__ . '/video',
		array(
			'render_callback' => 'gutenberg_render_block_core_video',
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_video', 20 );
