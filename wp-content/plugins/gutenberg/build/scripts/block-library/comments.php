...
function gutenberg_render_block_core_comments( $attributes, $content, $block ) {
	...
	gutenberg_enqueue_legacy_post_comments_block_styles( $block->name );
 ...
 * @since 6.1.0
 */
function gutenberg_register_block_core_comments() {
	register_block_type_from_metadata(
		__DIR__ . '/comments',
		array(
			'render_callback'   => 'gutenberg_render_block_core_comments',
			'skip_inner_blocks' => true,
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_comments', 20 );
 ...
 */
function gutenberg_comments_block_form_defaults( $fields ) {
...
add_filter( 'comment_form_defaults', 'gutenberg_comments_block_form_defaults' );
 ...
 */
function gutenberg_enqueue_legacy_post_comments_block_styles( $block_name ) {
