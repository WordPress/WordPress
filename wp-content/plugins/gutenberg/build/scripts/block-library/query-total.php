 ...
 */
function gutenberg_render_block_core_query_total( $attributes, $content, $block ) {
	global $wp_query;
 ...
 * @since 6.8.0
 */
function gutenberg_register_block_core_query_total() {
	register_block_type_from_metadata(
		__DIR__ . '/query-total',
		array(
			'render_callback' => 'gutenberg_render_block_core_query_total',
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_query_total', 20 );
