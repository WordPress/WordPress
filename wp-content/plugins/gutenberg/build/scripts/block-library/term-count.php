 ...
 */
function gutenberg_render_block_core_term_count( $attributes, $content, $block ) {
 ...
 * @since 6.9.0
 */
function gutenberg_register_block_core_term_count() {
	register_block_type_from_metadata(
		__DIR__ . '/term-count',
		array(
			'render_callback' => 'gutenberg_render_block_core_term_count',
		)
	);
}
add_action( 'init', 'gutenberg_register_block_core_term_count', 20 );
