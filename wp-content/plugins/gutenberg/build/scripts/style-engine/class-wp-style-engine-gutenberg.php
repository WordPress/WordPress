...
if ( ! class_exists( 'WP_Style_Engine_Gutenberg' ) ) {
	 ...
	 * @access private
	 */
	final class WP_Style_Engine_Gutenberg {
		/**
		...
		public static function get_store( $store_name ) {
			return WP_Style_Engine_CSS_Rules_Store_Gutenberg::get_store( $store_name );
		}
		...
		public static function compile_css( $css_declarations, $css_selector ) {
			...
			if ( $css_selector ) {
				$css_rule = new WP_Style_Engine_CSS_Rule_Gutenberg( $css_selector, $css_declarations );
				return $css_rule->get_css();
			}

			$css_declarations = new WP_Style_Engine_CSS_Declarations_Gutenberg( $css_declarations );
		 ...
		 *
		 * @param WP_Style_Engine_CSS_Rule_Gutenberg[] $css_rules An array of WP_Style_Engine_CSS_Rule_Gutenberg objects from a store or otherwise.
		 * @param array                      $options   {
		 *     Optional. An array of options. Default empty array.
		 *
