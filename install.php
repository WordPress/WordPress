...
weblog_title=My+Weblog&user_name=testuser&admin_password=password123&admin_password2=password123&admin_email=testuser%40example.com&blog_public=1
...
<form action="your_php_script.php" method="post" enctype="multipart/form-data">
    <!-- Weblog Title -->
    <p>
        <label for="weblog_title">Website Title</label><br>
        <input type="text" name="weblog_title" id="weblog_title" required>
    </p>
    ...
    <p>
        <label for="admin_password2">Confirm Password</label><br>
        <input type="password" name="admin_password2" id="admin_password2" required>
    </p>
    ...
    <!-- File Upload -->
    <p>
        <label for="file_upload">Choose a file to upload</label><br>
    ...
    <p>
        <label>
            <input type="checkbox" name="blog_public" value="0">
            Discourage search engines from indexing this site.
        </label>
        <small>This setting is a suggestion to search engines. It's not a guarantee.</small>
    </p>
