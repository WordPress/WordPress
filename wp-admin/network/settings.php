...
<?php echo esc_textarea( stripslashes( get_site_option('first_comment') ) ) ?></textarea>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td><?php printf( _x( '%s KB', 'File size in kilobytes' ), '<input name="fileupload_maxk" type="number" step="100" min="0" style="width: 100px" id="fileupload_maxk" value="' . esc_attr( get_site_option( 'fileupload_maxk', 300 ) ) . '" />' ); ?></td>
			</tr>
		</table>
