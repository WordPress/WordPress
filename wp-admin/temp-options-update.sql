...
-- // email settings
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(38,'mailserver_url', 3, 'mail.example.com', 'mailserver settings', 8);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(39,'mailserver_login', 3, 'login@example.com', 'mailserver settings', 8);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(40,'mailserver_pass', 3, 'password', 'mailserver settings', 8);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(41,'mailserver_port', 1, '110', 'mailserver settings', 8);
...
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(48,'posts_per_page', 1, '10','How many posts/days to show on the index page.', 4);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(49,'what_to_show', 5, 'posts','Posts, days, or posts paged', 4);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(50,'archive_mode', 5, 'monthly','Which \'unit\' to use for archives.', 4);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(51,'time_difference', 6, '0', 'if you\'re not on the timezone of your server', 4);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(52,'date_format', 3, 'd/m/Y', 'see note for format characters', 4);
INSERT INTO options (option_id, option_name, option_type, option_value, option_description, option_admin_level) VALUES(53,'time_format', 3, 'g:i a', 'see note for format characters', 4);
