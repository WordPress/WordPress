...
function image_size_input_fields( $post, $check = '' ) {
	...
	foreach ( $size_names as $size => $label ) {
		...
		$html = "<div class='image-size-item'><input type='radio' " . disabled( $enabled,
		                                                                        false,
...
function get_compat_media_markup( $attachment_id, $args = null ) {
	...
	if ( isset( $args['in_modal'] ) && $args['in_modal'] ) {
		foreach ( get_attachment_taxonomies( $post ) as $taxonomy ) {
			$t = (array) get_taxonomy( $taxonomy );
...
function media_upload_gallery_form( $errors ) {
    ...
    <form enctype="multipart/form-data" method="post" action="<?php echo esc_url( $form_action_url ); ?>" class="<?php echo $form_class; ?>" id="gallery-form">
        ...
        <div id="gallery-settings" style="display:none;">
            ...
            <p class="ml-submit">
                <input type="button" class="button" style="display:none;" onMouseDown="wpgallery.update();" name="insert-gallery" id="insert-gallery"
                       value="<?php esc_attr_e( 'Insert gallery' ); ?>"/>
                <input type="button" class="button" style="display:none;" onMouseDown="wpgallery.update();" name="update-gallery" id="update-gallery"
    ...
    <div class="wp_attachment_details edit-form-section">
		<?php if ( 'image' === substr( $post->post_mime_type, 0, 5 ) ) : ?>
            <p class="attachment-alt-text">
                ...
                <input type="text" class="widefat" name="_wp_attachment_image_alt" id="attachment_alt" aria-describedby="alt-text-description"
