...
global $pagenow, $is_lynx, $is_gecko, $is_winIE, $is_macIE, $is_opera, $is_NS4, $is_safari, $is_chrome, $is_iphone, $is_IE, $is_edge;
 ...
 */
$is_caddy = ( strpos( $_SERVER['SERVER_SOFTWARE'], 'Caddy' ) !== false || strpos( $_SERVER['SERVER_SOFTWARE'], 'FrankenPHP' ) !== false );
