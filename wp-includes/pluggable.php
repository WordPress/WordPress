...
/**
 * Retrieve the avatar image URL for a user who provided a user ID or email address.
 *
 * @since 2.5
 * @param int|string|object $id_or_email A user ID,  email address, or comment object
 * @param int $size Size of the avatar image
 * @param string $default URL to a default image to use if no avatar is available
 * @return string URL for user avatar image
*/
function get_avatar_url( $id_or_email, $size = '96', $default = '' ) {
	...
	return apply_filters('get_avatar_url', $avatar, $id_or_email, $size, $default);
}
endif;
