...
function x() {
  ...
  for (i.sort(preact_module_f); n = i.shift();) n.__d && (l = i.length, t = void 0, r = (o = (u = n).__v).__e, c = [], s = [], (e = u.__P) && ((t = v({}, o)).__v = o.__v + 1, L(e, t, o, u.__n, void 0 !== e.ownerSVGElement, 32 & o.__u ? [r] : null, c, null == r ? m(o) : r, !!(32 & o.__u), s), t.__.__k[t.__i] = t, M(c, t, s), t.__e != r && k(t)), i.length > l && i.sort(preact_module_f));
  x.__r = 0;
}
