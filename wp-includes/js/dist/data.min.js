 ...
 */
function Re(e){return"[object Object]"===Object.prototype.toString.call(e)}function Ee(e){var t,r;return!1!==Re(e)&&(void 0===(t=e.constructor)||!1!==Re(r=t.prototype)&&!1!==r.hasOwnProperty("isPrototypeOf"))}var _e=r(1919),Ie=r.n(_e);let Te;const je={getItem(e){return Te&&Te[e]?Te[e]:null},setItem(e,t){Te||je.clear(),Te[e]=String(t)},clear(){Te=Object.create(null)}};var Ne=je;let Ae;try{Ae=window.localStorage,Ae.setItem("__wpDataTestLocalStorage",""),Ae.removeItem("__wpDataTestLocalStorage")}catch(e){Ae=Ne}const Pe=Ae,Le="WP_DATA";function xe(e,t){const r=function(e){const{storage:t=Pe,storageKey:r=Le}=e;let n;return{get:function(){if(void 0===n){const e=t.getItem(r);if(null===e)n={};else try{n=JSON.parse(e)}catch(e){n={}}}return n},set:function(e,o){n={...n,[e]:o},t.setItem(r,JSON.stringify(n))}}}(t);return{registerStore(t,n){if(!n.persist)return e.registerStore(t,n);const o=r.get()[t];if(void 0!==o){let e=n.reducer(n.initialState,{type:"@@WP/PERSISTENCE_RESTORE"});e=Ee(e)&&Ee(o)?Ie()(e,o,{isMergeableObject:Ee}):o,n={...n,initialState:e}}const s=e.registerStore(t,n);return s.subscribe(function(e,t,n){let o;if(Array.isArray(n)){const e=n.reduce(((e,t)=>Object.assign(e,{[t]:(e,r)=>r.nextState[t]})),{});s=ut(e),o=(e,t)=>t.nextState===e?e:s(e,t)}else o=(e,t)=>t.nextState;var s;let i=o(void 0,{nextState:e()});return()=>{const n=o(i,{nextState:e()});n!==i&&(r.set(t,n),i=n)}}(s.getState,t,n.persist)),s}}}xe.__unstableMigrate=()=>{};var Me=xe,Fe=window.wp.element,Ue=window.wp.priorityQueue,De=window.wp.isShallowEqual,Ce=r.n(De);const ke=(0,Fe.createContext)(we),{Consumer:Ve,Provider:Ge}=ke,He=Ve;var Ke=Ge;function We(){return(0,Fe.useContext)(ke)}const Be=(0,Fe.createContext)(!1),{Consumer:$e,Provider:Xe}=Be;var qe=Xe;const ze=(0,Ue.createQueue)();function Je(e,t){const r=t?e.suspendSelect:e.select,n={};let o,s,i,u,c=!1;return(t,a)=>{function l(){if(c&&t===o)return s;const a={current:null},l=e.__unstableMarkListeningStores((()=>t(r,e)),a);u?u.updateStores(a.current):u=(t=>{const r=[...t],o=new Set;return{subscribe:function(t){c=!1;const s=()=>{c=!1,t()},u=()=>{i?ze.add(n,s):s()},a=[];function l(t){a.push(e.subscribe(u,t))}for(const e of r)l(e);return o.add(l),()=>{o.delete(l);for(const e of a.values())e?.();ze.cancel(n)}},updateStores:function(e){for(const t of e)if(!r.includes(t)){r.push(t);for(const e of o)e(t)}}}})(a.current),Ce()(s,l)||(s=l),o=t,c=!0}return i&&!a&&(c=!1,ze.cancel(n)),l(),i=a,{subscribe:u.subscribe,getValue:function(){return l(),s}}}}function Qe(e,t,r){const n=We(),o=(0,Fe.useContext)(Be),s=(0,Fe.useMemo)((()=>Je(n,e)),[n]),i=(0,Fe.useCallback)(t,r),{subscribe:u,getValue:c}=s(i,o),a=(0,Fe.useSyncExternalStore)(u,c,c);return(0,Fe.useDebugValue)(a),a}function Ye(e,t){const r="function"!=typeof e,n=(0,Fe.useRef)(r);if(r!==n.current){const e=n.current?"static":"mapping";throw new Error(`Switching useSelect from ${e} to ${r?"static":"mapping"} is not allowed`)}return r?(o=e,We().select(o)):Qe(!1,e,t);var o}function Ze(e,t){return Qe(!0,e,t)}var et=e=>(0,I.createHigherOrderComponent)((t=>(0,I.pure)((r=>{const n=Ye(((t,n)=>e(t,r,n)));return(0,Fe.createElement)(t,{...r,...n})}))),"withSelect");var tt=(e,t)=>{const r=We(),n=(0,Fe.useRef)(e);return(0,I.useIsomorphicLayoutEffect)((()=>{n.current=e})),(0,Fe.useMemo)((()=>{const e=n.current(r.dispatch,r);return Object.fromEntries(Object.entries(e).map((([e,t])=>("function"!=typeof t&&console.warn(`Property ${e} returned from dispatchMap in useDispatchWithMap must be a function.`),[e,(...t)=>n.current(r.dispatch,r)[e](...t)]))))}),[r,...t])};var rt=e=>(0,I.createHigherOrderComponent)((t=>r=>{const n=tt(((t,n)=>e(t,r,n)),[]);return(0,Fe.createElement)(t,{...r,...n})}),"withDispatch");var nt=(0,I.createHigherOrderComponent)((e=>t=>(0,Fe.createElement)(He,null,(r=>(0,Fe.createElement)(e,{...t,registry:r})))),"withRegistry");var ot=e=>{const{dispatch:t}=We();return void 0===e?t:t(e)};function st(e){return we.dispatch(e)}function it(e){return we.select(e)}const ut=i(),ct=we.resolveSelect,at=we.suspendSelect,lt=we.subscribe,ft=we.registerGenericStore,pt=we.registerStore,gt=we.use,yt=we.register}(),(window.wp=window.wp||{}).data=n}();