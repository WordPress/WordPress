...
(wp ||= {}).editPost = (() => {
  ...
  var require_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React48 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef21 = React48.useRef, useEffect17 = React48.useEffect, useMemo17 = React48.useMemo, useDebugValue2 = React48.useDebugValue;
  ...
  var Portal = (0, import_element9.forwardRef)(
  ...
  var Positioner = (0, import_element10.forwardRef)(
  ...
  var Popup = (0, import_element11.forwardRef)(function TooltipPopup3({ portal, positioner, children, className, ...props }, ref) {
    const popupContent = (
       ...
       *     below
       */
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ThemeProvider, { color: { bg: "#1e1e1e" }, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
  ...
  var VisuallyHidden = (0, import_element13.forwardRef)(
  ...
  var NavigableRegion = (0, import_element14.forwardRef)(
  ...
  var useUpdatePostLinkListener = () => {
    ...
    const nodeToUpdateRef = (0, import_element15.useRef)();
  ...
  function InitPatternModal() {
    ...
    const [syncType, setSyncType] = (0, import_element17.useState)(void 0);
    const [title, setTitle] = (0, import_element17.useState)("");
    const isNewPost = (0, import_data8.useSelect)(
      (select3) => select3(import_editor6.store).isCleanNewPost(),
      []
    );
    const [isModalOpen, setIsModalOpen] = (0, import_element17.useState)(() => isNewPost);
    if (!isNewPost) {
      return null;
    }
  ...
  function BrowserURL() {
    const [historyId, setHistoryId] = (0, import_element18.useState)(null);
  ...
  function MetaBoxesArea({ location }) {
    const container = (0, import_element19.useRef)(null);
    const formRef = (0, import_element19.useRef)(null);
  ...
  function CustomFieldsConfirmation({ willEnable }) {
    const [isReloading, setIsReloading] = (0, import_element21.useState)(false);
  ...
  function EnableCustomFieldsOption({ label }) {
    ...
    const [isChecked, setIsChecked] = (0, import_element21.useState)(areCustomFieldsEnabled);
        ...
        pages: [
          ...
          },
          {
            ...
            content: /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("p", { className: "edit-post-welcome-guide__text", children: (0, import_element22.createInterpolateElement)(
                (0, import_i18n11.__)(
  ...
  function useNavigateToEntityRecord(initialPostId, initialPostType, defaultRenderingMode) {
    ...
    const [postHistory, dispatch2] = (0, import_element23.useReducer)(
    ...
    const onNavigateToPreviousEntityRecord = (0, import_element23.useCallback)(() => {
  ...
  function MetaBoxesMain({ isLegacy }) {
    ...
    const [{ min: min2 = 0, max: max2 }, setHeightConstraints] = (0, import_element25.useState)(() => ({}));
    ...
    const metaBoxesMainRef = (0, import_element25.useRef)();
    const setMainRefs = (0, import_compose3.useMergeRefs)([
      metaBoxesMainRef,
      effectSizeConstraints
    ]);
    const separatorRef = (0, import_element25.useRef)();
    const separatorHelpId = (0, import_element25.useId)();
    const heightRef = (0, import_element25.useRef)();
  ...
  function Layout({
    ...
    const editorSettings = (0, import_element25.useMemo)(
      () => ({
        ...settings,
        styles,
        onNavigateToEntityRecord,
    ...
    const onActionPerformed = (0, import_element25.useCallback)(
      (actionId, items) => {
        switch (actionId) {
          case "move-to-trash":
            {
    ...
    const initialPost = (0, import_element25.useMemo)(() => {
      return {
  ...
  function initializeEditor(id, postType, postId, settings, initialEdits) {
    ...
    preloadedResolutions.finally(() => {
      ...
      root.render(
        /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(import_element26.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
          layout_default,
          {
            settings,
            postId,
