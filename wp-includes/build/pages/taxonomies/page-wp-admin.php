<?php
/**
 * Page: taxonomies (wp-admin integrated)
...
global $wp_taxonomies_wp_admin_routes, $wp_taxonomies_wp_admin_menu_items;
$wp_taxonomies_wp_admin_routes     = array();
$wp_taxonomies_wp_admin_menu_items = array();

/**
 * Register a route for the taxonomies-wp-admin page.
 *
 ...
 */
function wp_register_taxonomies_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $wp_taxonomies_wp_admin_routes;
	...
	$wp_taxonomies_wp_admin_routes[] = $route;
}

/**
 * Register a menu item for the taxonomies-wp-admin page.
 ...
 */
function wp_register_taxonomies_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $wp_taxonomies_wp_admin_menu_items;
	...
	$wp_taxonomies_wp_admin_menu_items[] = $menu_item;
}

/**
 * Get all registered routes for the taxonomies-wp-admin page.
 *
 * @return array Array of route objects.
 */
function wp_get_taxonomies_wp_admin_routes() {
	global $wp_taxonomies_wp_admin_routes;
	return $wp_taxonomies_wp_admin_routes ?? array();
}

/**
 * Get all registered menu items for the taxonomies-wp-admin page.
 *
 * @return array Array of menu item objects.
 */
function wp_get_taxonomies_wp_admin_menu_items() {
	global $wp_taxonomies_wp_admin_menu_items;
	return $wp_taxonomies_wp_admin_menu_items ?? array();
}

/**
 * Preload REST API data for the taxonomies-wp-admin page.
 * Automatically called during page rendering.
 */
function wp_taxonomies_wp_admin_preload_data() {
...
/**
 * Render the taxonomies-wp-admin page.
 * Call this function from add_menu_page or add_submenu_page.
 * This renders within the normal WordPress admin interface.
 */
function wp_taxonomies_wp_admin_render_page() {
	?>
	<style>
	...
	<div id="taxonomies-wp-admin-app" class="boot-layout-container"></div>
	<?php
}

// Hook the enqueue function to admin_enqueue_scripts
add_action( 'admin_enqueue_scripts', 'wp_taxonomies_wp_admin_enqueue_scripts' );
