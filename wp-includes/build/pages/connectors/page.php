...
global $wp_connectors_routes, $wp_connectors_menu_items;
$wp_connectors_routes     = array();
$wp_connectors_menu_items = array();

if ( ! function_exists( 'wp_register_connectors_route' ) ) {
	/**
	 ...
	 */
	function wp_register_connectors_route( $path, $content_module = null, $route_module = null ) {
		global $wp_connectors_routes;
		...
		$wp_connectors_routes[] = $route;
	}
}

if ( ! function_exists( 'wp_register_connectors_menu_item' ) ) {
	/**
	 ...
	 */
	function wp_register_connectors_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
		global $wp_connectors_menu_items;
		...
		$wp_connectors_menu_items[] = $menu_item;
	}
}

if ( ! function_exists( 'wp_get_connectors_routes' ) ) {
	/**
	 * Get all registered routes for the connectors page.
	 *
	 * @return array Array of route objects.
	 */
	function wp_get_connectors_routes() {
		global $wp_connectors_routes;
		return $wp_connectors_routes ?? array();
	}
}

if ( ! function_exists( 'wp_get_connectors_menu_items' ) ) {
	/**
	 * Get all registered menu items for the connectors page.
	 *
	 * @return array Array of menu item objects.
	 */
	function wp_get_connectors_menu_items() {
		global $wp_connectors_menu_items;
		return $wp_connectors_menu_items ?? array();
	}
}

if ( ! function_exists( 'wp_connectors_preload_data' ) ) {
	/**
	 * Preload REST API data for the connectors page.
	 * Automatically called during page rendering.
	 */
	function wp_connectors_preload_data() {
...
if ( ! function_exists( 'wp_connectors_render_page' ) ) {
	/**
	 * Render the connectors page.
	 * Call this function from add_menu_page or add_submenu_page.
	 */
	function wp_connectors_render_page() {
		...
		wp_connectors_preload_data();

		// Get all registered routes and menu items
		$menu_items = wp_get_connectors_menu_items();
		$routes = wp_get_connectors_routes();
...
add_action( 'admin_init', 'wp_connectors_intercept_render' );
