...
global $wp_dashboard_wp_admin_routes, $wp_dashboard_wp_admin_menu_items;
$wp_dashboard_wp_admin_routes     = array();
$wp_dashboard_wp_admin_menu_items = array();
 ...
 */
function wp_register_dashboard_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $wp_dashboard_wp_admin_routes;
	...
	$wp_dashboard_wp_admin_routes[] = $route;
}
 ...
 */
function wp_register_dashboard_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $wp_dashboard_wp_admin_menu_items;
	...
	$wp_dashboard_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function wp_get_dashboard_wp_admin_routes() {
	global $wp_dashboard_wp_admin_routes;
	return $wp_dashboard_wp_admin_routes ?? array();
}
 ...
 */
function wp_get_dashboard_wp_admin_menu_items() {
	global $wp_dashboard_wp_admin_menu_items;
	return $wp_dashboard_wp_admin_menu_items ?? array();
}
 ...
 */
function wp_dashboard_wp_admin_preload_data() {
 ...
 */
function wp_dashboard_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	wp_dashboard_wp_admin_preload_data();

	// Get all registered routes
	$routes = wp_get_dashboard_wp_admin_routes();
 ...
 */
function wp_dashboard_wp_admin_render_page() {
	?>
	<style>
...
add_action( 'admin_enqueue_scripts', 'wp_dashboard_wp_admin_enqueue_scripts' );
