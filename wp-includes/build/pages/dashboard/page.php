...
global $wp_dashboard_routes, $wp_dashboard_menu_items;
$wp_dashboard_routes     = array();
$wp_dashboard_menu_items = array();
 ...
 */
function wp_register_dashboard_route( $path, $content_module = null, $route_module = null ) {
	global $wp_dashboard_routes;
 ...
 */
function wp_register_dashboard_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $wp_dashboard_menu_items;
	...
	$wp_dashboard_menu_items[] = $menu_item;
}
...
function wp_get_dashboard_routes() {
	global $wp_dashboard_routes;
	return $wp_dashboard_routes ?? array();
}
 ...
 */
function wp_get_dashboard_menu_items() {
	global $wp_dashboard_menu_items;
	return $wp_dashboard_menu_items ?? array();
}
 ...
 */
function wp_dashboard_preload_data() {
 ...
 */
function wp_dashboard_render_page() {
	...
	wp_dashboard_preload_data();

	// Get all registered routes and menu items
	$menu_items = wp_get_dashboard_menu_items();
	$routes = wp_get_dashboard_routes();
 ...
 */
function wp_dashboard_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'dashboard' === $_GET['page'] ) {
		wp_dashboard_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'wp_dashboard_intercept_render' );
