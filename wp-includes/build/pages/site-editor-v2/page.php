...
global $wp_site_editor_v2_routes, $wp_site_editor_v2_menu_items;
$wp_site_editor_v2_routes     = array();
$wp_site_editor_v2_menu_items = array();

if ( ! function_exists( 'wp_register_site_editor_v2_route' ) ) {
	/**
	 ...
	 */
	function wp_register_site_editor_v2_route( $path, $content_module = null, $route_module = null ) {
		global $wp_site_editor_v2_routes;
		...
		$wp_site_editor_v2_routes[] = $route;
	}
}

if ( ! function_exists( 'wp_register_site_editor_v2_menu_item' ) ) {
	/**
	 ...
	 */
	function wp_register_site_editor_v2_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
		global $wp_site_editor_v2_menu_items;
		...
		$wp_site_editor_v2_menu_items[] = $menu_item;
	}
}

if ( ! function_exists( 'wp_get_site_editor_v2_routes' ) ) {
	/**
	 * Get all registered routes for the site-editor-v2 page.
	 *
	 * @return array Array of route objects.
	 */
	function wp_get_site_editor_v2_routes() {
		global $wp_site_editor_v2_routes;
		return $wp_site_editor_v2_routes ?? array();
	}
}

if ( ! function_exists( 'wp_get_site_editor_v2_menu_items' ) ) {
	/**
	 * Get all registered menu items for the site-editor-v2 page.
	 *
	 * @return array Array of menu item objects.
	 */
	function wp_get_site_editor_v2_menu_items() {
		global $wp_site_editor_v2_menu_items;
		return $wp_site_editor_v2_menu_items ?? array();
	}
}

if ( ! function_exists( 'wp_site_editor_v2_preload_data' ) ) {
	/**
	 * Preload REST API data for the site-editor-v2 page.
	 * Automatically called during page rendering.
	 */
	function wp_site_editor_v2_preload_data() {
...
if ( ! function_exists( 'wp_site_editor_v2_render_page' ) ) {
	/**
	 * Render the site-editor-v2 page.
	 * Call this function from add_menu_page or add_submenu_page.
	 */
	function wp_site_editor_v2_render_page() {
		...
		wp_site_editor_v2_preload_data();

		// Get all registered routes and menu items
		$menu_items = wp_get_site_editor_v2_menu_items();
		$routes = wp_get_site_editor_v2_routes();
...
add_action( 'admin_init', 'wp_site_editor_v2_intercept_render' );
