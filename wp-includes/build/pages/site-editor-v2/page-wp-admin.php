...
global $wp_site_editor_v2_wp_admin_routes, $wp_site_editor_v2_wp_admin_menu_items;
$wp_site_editor_v2_wp_admin_routes     = array();
$wp_site_editor_v2_wp_admin_menu_items = array();

if ( ! function_exists( 'wp_register_site_editor_v2_wp_admin_route' ) ) {
	/**
	 ...
	 */
	function wp_register_site_editor_v2_wp_admin_route( $path, $content_module = null, $route_module = null ) {
		global $wp_site_editor_v2_wp_admin_routes;
		...
		$wp_site_editor_v2_wp_admin_routes[] = $route;
	}
}

if ( ! function_exists( 'wp_register_site_editor_v2_wp_admin_menu_item' ) ) {
	/**
	 ...
	 */
	function wp_register_site_editor_v2_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
		global $wp_site_editor_v2_wp_admin_menu_items;
		...
		$wp_site_editor_v2_wp_admin_menu_items[] = $menu_item;
	}
}

if ( ! function_exists( 'wp_get_site_editor_v2_wp_admin_routes' ) ) {
	/**
	 * Get all registered routes for the site-editor-v2-wp-admin page.
	 *
	 * @return array Array of route objects.
	 */
	function wp_get_site_editor_v2_wp_admin_routes() {
		global $wp_site_editor_v2_wp_admin_routes;
		return $wp_site_editor_v2_wp_admin_routes ?? array();
	}
}

if ( ! function_exists( 'wp_get_site_editor_v2_wp_admin_menu_items' ) ) {
	/**
	 * Get all registered menu items for the site-editor-v2-wp-admin page.
	 *
	 * @return array Array of menu item objects.
	 */
	function wp_get_site_editor_v2_wp_admin_menu_items() {
		global $wp_site_editor_v2_wp_admin_menu_items;
		return $wp_site_editor_v2_wp_admin_menu_items ?? array();
	}
}

if ( ! function_exists( 'wp_site_editor_v2_wp_admin_preload_data' ) ) {
	/**
	 * Preload REST API data for the site-editor-v2-wp-admin page.
	 * Automatically called during page rendering.
	 */
	function wp_site_editor_v2_wp_admin_preload_data() {
...
if ( ! function_exists( 'wp_site_editor_v2_wp_admin_enqueue_scripts' ) ) {
	/**
	 ...
	 */
	function wp_site_editor_v2_wp_admin_enqueue_scripts( $hook_suffix ) {
		...
		wp_site_editor_v2_wp_admin_preload_data();

		// Get all registered routes
		$routes = wp_get_site_editor_v2_wp_admin_routes();
...
add_action( 'admin_enqueue_scripts', 'wp_site_editor_v2_wp_admin_enqueue_scripts' );
