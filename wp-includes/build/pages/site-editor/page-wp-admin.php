...
if ( ! function_exists( 'register_site_editor_wp_admin_menu_item' ) ) {
	/**
...
if ( ! function_exists( 'get_site_editor_wp_admin_routes' ) ) {
	/**
...
if ( ! function_exists( 'get_site_editor_wp_admin_menu_items' ) ) {
	/**
...
if ( ! function_exists( 'site_editor_wp_admin_preload_data' ) ) {
	/**
...
if ( ! function_exists( 'site_editor_wp_admin_enqueue_scripts' ) ) {
	/**
	...
	function site_editor_wp_admin_enqueue_scripts( $hook_suffix ) {
		...
		$routes = get_site_editor_wp_admin_routes();
...
if ( ! function_exists( 'site_editor_wp_admin_render_page' ) ) {
	/**
...
add_action( 'admin_enqueue_scripts', 'site_editor_wp_admin_enqueue_scripts' );
