...
if ( ! function_exists( 'register_site_editor_menu_item' ) ) {
	/**
...
if ( ! function_exists( 'get_site_editor_routes' ) ) {
	/**
...
if ( ! function_exists( 'get_site_editor_menu_items' ) ) {
	/**
...
if ( ! function_exists( 'site_editor_preload_data' ) ) {
	/**
...
if ( ! function_exists( 'site_editor_render_page' ) ) {
	/**
...
if ( ! function_exists( 'site_editor_intercept_render' ) ) {
	/**
...
add_action( 'admin_init', 'site_editor_intercept_render' );
