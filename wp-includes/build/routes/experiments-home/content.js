...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React59 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef30 = React59.useRef, useEffect23 = React59.useEffect, useMemo34 = React59.useMemo, useDebugValue2 = React59.useDebugValue;
...
function useCollapsibleRoot(parameters) {
  ...
  const [visible, setVisible] = React14.useState(open);
  const [{
    height,
    width
  }, setDimensions] = React14.useState({
    height: void 0,
    width: void 0
  });
  ...
  const [hiddenUntilFound, setHiddenUntilFound] = React14.useState(false);
  const [keepMounted, setKeepMounted] = React14.useState(false);
  const abortControllerRef = React14.useRef(null);
  const animationTypeRef = React14.useRef(null);
  const transitionDimensionRef = React14.useRef(null);
...
function useCollapsiblePanel(parameters) {
  ...
  const isBeforeMatchRef = React19.useRef(false);
  const latestAnimationNameRef = React19.useRef(null);
  const shouldCancelInitialOpenAnimationRef = React19.useRef(open);
  const shouldCancelInitialOpenTransitionRef = React19.useRef(open);
  const endingStyleFrame = useAnimationFrame();
  const hidden = React19.useMemo(() => {
    if (animationTypeRef.current === "css-animation") {
      return !visible;
    }
    return !open && !mounted;
...
var FloatingDelayGroupContext = /* @__PURE__ */ React22.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
function FloatingDelayGroup(props) {
  ...
  const delayRef = React22.useRef(delay);
  const initialDelayRef = React22.useRef(delay);
  const currentIdRef = React22.useRef(null);
  const currentContextRef = React22.useRef(null);
  const timeout = useTimeout();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingDelayGroupContext.Provider, {
    value: React22.useMemo(() => ({
      hasProvider: true,
      delayRef,
      initialDelayRef,
      currentIdRef,
...
function useDelayGroup(context, options = {
  ...
  const groupContext = React22.useContext(FloatingDelayGroupContext);
  const {
    currentIdRef,
    delayRef,
    timeoutMs,
  ...
  const [isInstantPhase, setIsInstantPhase] = React22.useState(false);
  useIsoLayoutEffect(() => {
    function unset() {
...
var FocusGuard = /* @__PURE__ */ React23.forwardRef(function FocusGuard2(props, ref) {
  const [role, setRole] = React23.useState();
  useIsoLayoutEffect(() => {
    if (isSafari) {
      setRole("button");
    }
...
var PortalContext = /* @__PURE__ */ React24.createContext(null);
if (true) PortalContext.displayName = "PortalContext";
var usePortalContext = () => React24.useContext(PortalContext);
...
function useFloatingPortalNode(props = {}) {
  ...
  const [containerElement, setContainerElement] = React24.useState(null);
  const [portalNode, setPortalNode] = React24.useState(null);
...
var FloatingPortal = /* @__PURE__ */ React24.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  const beforeOutsideRef = React24.useRef(null);
  const afterOutsideRef = React24.useRef(null);
  const beforeInsideRef = React24.useRef(null);
  const afterInsideRef = React24.useRef(null);
  const [focusManagerState, setFocusManagerState] = React24.useState(null);
  const focusInsideDisabledRef = React24.useRef(false);
  ...
  const portalContextValue = React24.useMemo(() => ({
    beforeOutsideRef,
    afterOutsideRef,
    beforeInsideRef,
    afterInsideRef,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(React24.Fragment, {
...
var FloatingNodeContext = /* @__PURE__ */ React25.createContext(null);
if (true) FloatingNodeContext.displayName = "FloatingNodeContext";
var FloatingTreeContext = /* @__PURE__ */ React25.createContext(null);
if (true) FloatingTreeContext.displayName = "FloatingTreeContext";
var useFloatingParentNodeId = () => React25.useContext(FloatingNodeContext)?.id || null;
var useFloatingTree = (externalTree) => {
  const contextTree = React25.useContext(FloatingTreeContext);
...
function useClientPoint(context, props = {}) {
  ...
  const addListener = React26.useCallback(() => {
...
function useFloating2(options = {}) {
  ...
  const [localFloatingElement, setLocalFloatingElement] = React33.useState(null);
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const closeWithDelay = React35.useCallback((event) => {
...
function useInteractions(propsList = []) {
  ...
  const getReferenceProps = React37.useCallback(
    (userProps) => mergeProps2(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    referenceDeps
  );
  const getFloatingProps = React37.useCallback(
    (userProps) => mergeProps2(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    floatingDeps
  );
  const getItemProps = React37.useCallback(
    (userProps) => mergeProps2(userProps, propsList, "item"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    itemDeps
  );
  const getTriggerProps = React37.useCallback(
...
var CollapsiblePanel = /* @__PURE__ */ React41.forwardRef(function CollapsiblePanel2(componentProps, forwardedRef) {
  ...
  const panelState = React41.useMemo(() => ({
    ...state,
    transitionStatus
...
function usePopupAutoResize(parameters) {
  ...
  const liveDimensionsRef = React43.useRef(null);
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(React44.Fragment, {
...
var FloatingPortalLite = /* @__PURE__ */ React45.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(React45.Fragment, {
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  const activeTriggerProps = React48.useMemo(() => getReferenceProps(), [getReferenceProps]);
  const inactiveTriggerProps = React48.useMemo(() => getTriggerProps(), [getTriggerProps]);
  const popupProps = React48.useMemo(() => getFloatingProps(), [getFloatingProps]);
  store.useSyncedValues({
    activeTriggerProps,
    inactiveTriggerProps,
    popupProps
  });
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TooltipRootContext.Provider, {
    value: store,
...
var Text = (0, import_element8.forwardRef)(function Text2({ variant = "body-md", render: render4, className, ...props }, ref) {
...
var Root = (0, import_element11.forwardRef)(function Card({ render: render4, ...restProps }, ref) {
...
var Header = (0, import_element12.forwardRef)(
...
var Content = (0, import_element13.forwardRef)(
...
var FullBleed = (0, import_element14.forwardRef)(
...
var Title = (0, import_element15.forwardRef)(
...
var Panel = (0, import_element16.forwardRef)(
  function CollapsiblePanel3(props, forwardedRef) {
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(index_parts_exports.Panel, { ref: forwardedRef, ...props });
  }
);
...
var Root2 = (0, import_element17.forwardRef)(
  function CollapsibleRoot3(props, forwardedRef) {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(index_parts_exports.Root, { ref: forwardedRef, ...props });
  }
);
...
var Trigger = (0, import_element18.forwardRef)(
  function CollapsibleTrigger3(props, forwardedRef) {
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(index_parts_exports.Trigger, { ref: forwardedRef, ...props });
  }
);
...
var Root3 = (0, import_element19.forwardRef)(
  function CollapsibleCardRoot({ render: render4, ...restProps }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      Root2,
      {
        ref,
        render: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Root, { render: render4 }),
        ...restProps
      }
    );
  }
...
var chevron_down_default = /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_primitives2.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_primitives2.Path, { d: "M17.5 11.6L12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z" }) });

// packages/icons/build-module/library/close-small.mjs
var import_primitives3 = __toESM(require_primitives(), 1);
var import_jsx_runtime20 = __toESM(require_jsx_runtime(), 1);
var close_small_default = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_primitives3.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_primitives3.Path, { d: "M12 13.06l3.712 3.713 1.061-1.06L13.061 12l3.712-3.712-1.06-1.06L12 10.938 8.288 7.227l-1.061 1.06L10.939 12l-3.712 3.712 1.06 1.061L12 13.061z" }) });

// packages/icons/build-module/library/envelope.mjs
var import_primitives4 = __toESM(require_primitives(), 1);
var import_jsx_runtime21 = __toESM(require_jsx_runtime(), 1);
var envelope_default = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_primitives4.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_primitives4.Path, { fillRule: "evenodd", clipRule: "evenodd", d: "M3 7c0-1.1.9-2 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7Zm2-.5h14c.3 0 .5.2.5.5v1L12 13.5 4.5 7.9V7c0-.3.2-.5.5-.5Zm-.5 3.3V17c0 .3.2.5.5.5h14c.3 0 .5-.2.5-.5V9.8L12 15.4 4.5 9.8Z" }) });
...
var Header2 = (0, import_element21.forwardRef)(
  function CollapsibleCardHeader({ children, className, render: render4, ...restProps }, ref) {
    const [descriptionId, setDescriptionId] = (0, import_element21.useState)();
    ...
    return useRender({
      ...
      props: mergeProps(restProps, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(HeaderDescriptionIdContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
          Trigger,
          {
            className: style_default7.header,
            render: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Header, {}),
            nativeButton: false,
            "aria-describedby": descriptionId,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: style_default7["header-content"], children }),
...
var HeaderDescription = (0, import_element22.forwardRef)(function CollapsibleCardHeaderDescription({ children, className, ...restProps }, ref) {
  const descriptionId = (0, import_element22.useId)();
  const { setDescriptionId } = (0, import_element22.useContext)(HeaderDescriptionIdContext);
...
var Content2 = (0, import_element23.forwardRef)(
...
var Stack = (0, import_element25.forwardRef)(function Stack2({ direction, gap, align, justify, wrap, render: render4, ...props }, ref) {
  const style = {
...
if (typeof process === "undefined" || true) {
  registerStyle10("45eb1fe20f", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;._11fc52b637ff8a7e__slot{inset:0;isolation:isolate;pointer-events:none;position:fixed;z-index:1000000003}@layer wp-ui-utilities{._11fc52b637ff8a7e__slot>*{pointer-events:auto}}");
}
...
var Popup = (0, import_element28.forwardRef)(function TooltipPopup3({ portal, positioner, children, className, ...props }, ref) {
  const popupContent = (
     ...
     *     below
     */
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ThemeProvider, { color: { bg: "#1e1e1e" }, children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
...
var Trigger2 = (0, import_element29.forwardRef)(
...
if (typeof process === "undefined" || true) {
  registerStyle13("c46e8cb841", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-components{.f37b9e2e191ebd66__visually-hidden{word-wrap:normal;border:0;clip-path:inset(50%);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;word-break:normal}}");
}
var style_default12 = { "visually-hidden": "f37b9e2e191ebd66__visually-hidden" };
var VisuallyHidden = (0, import_element30.forwardRef)(
...
var NavigableRegion = (0, import_element31.forwardRef)(
...
function Header3({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(Stack, { direction: "column", className: style_default13.header, children: [
...
function useElements({
  ...
  const [isLoading, setIsLoading] = (0, import_element32.useState)(false);
...
var isNoneOperatorDefinition = {
  ...
  filterText: (filter, activeElements) => (0, import_element33.createInterpolateElement)(
...
function Combobox({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(import_components3.Spinner, {});
  }
...
function RelativeDateControl({
  ...
  const onChangeValue = (0, import_element36.useCallback)(
    (newValue) => onChange(
      setValue({
        item: data,
  ...
  const onChangeUnit = (0, import_element36.useCallback)(
    (newUnit) => onChange(
      setValue({
        item: data,
...
function useDisabledDateMatchers(isValid2, parseDateFn) {
  ...
  const disabledMatchers = (0, import_element37.useMemo)(() => {
    const matchers = [];
    if (minConstraint) {
...
function CalendarDateTimeControl({
  ...
  const validationTimeoutRef = (0, import_element38.useRef)(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
    import_components5.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(Stack, { direction: "column", gap: "lg", children: [
        ...
        !compact && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
          DateCalendar,
          {
            style: { width: "100%" },
...
function Select({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(import_components7.Spinner, {});
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "email",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_components9.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_components9.Icon, { icon: envelope_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "tel",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(import_components10.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(import_components10.Icon, { icon: mobile_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "url",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_components11.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_components11.Icon, { icon: link_default }) })
      }
    }
  );
}
...
function BetweenControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(
    import_components12.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_components12.Flex, { direction: "row", gap: 4, children: [
...
function Radio({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(import_components13.Spinner, {});
  }
...
function ToggleGroup({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime59.jsx)(import_components16.Spinner, {});
  }
...
function ArrayControl({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(import_components17.Spinner, {});
  }
    ...
    import_components18.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
        import_components18.Button,
        {
          ...
          disabled: disabled2,
          accessibleWhenDisabled: true,
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components18.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components18.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
...
function Color({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
    ValidatedInputControl3,
    {
      ...
      type: "text",
      disabled: disabled2,
      prefix: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components18.__experimentalInputControlPrefixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
        ColorPickerDropdown,
        {
          color: value,
...
function Password({
  ...
  const [isVisible, setIsVisible] = (0, import_element50.useState)(false);
  const disabled2 = field.isDisabled({ item: data, field });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(import_components19.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(
...
var DataFormContext = (0, import_element51.createContext)({
  fields: []
});
...
function normalizeLayout(layout) {
  ...
  if (layout?.type === "regular") {
    ...
    if (typeof openAs === "object" && openAs.type === "modal") {
      normalizedOpenAs = {
        type: "modal",
        applyLabel: openAs.applyLabel?.trim() || (0, import_i18n15.__)("Apply"),
        cancelLabel: openAs.cancelLabel?.trim() || (0, import_i18n15.__)("Cancel")
      };
    } else if (openAs === "modal") {
      normalizedOpenAs = {
        type: "modal",
        applyLabel: (0, import_i18n15.__)("Apply"),
        cancelLabel: (0, import_i18n15.__)("Cancel")
      };
    } else {
...
function Header4({ title }) {
  return /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(
    Stack,
    {
      ...
      gap: "lg",
      children: /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(Stack, { direction: "row", align: "center", children: /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(import_components20.__experimentalHeading, { level: 2, size: 13, children: title }) })
    }
  );
}
function FormRegularField({
  ...
  const { fields } = (0, import_element52.useContext)(dataform_context_default);
  const layout = field.layout;
  const form = (0, import_element52.useMemo)(
    () => ({
      layout: DEFAULT_LAYOUT,
  ...
  if (!!field.children) {
    return /* @__PURE__ */ (0, import_jsx_runtime67.jsxs)(import_jsx_runtime67.Fragment, { children: [
      !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(Header4, { title: field.label }),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(import_components20.BaseControl.VisualLabel, { children: fieldDefinition.label })
            }
          ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime67.jsx)("div", { className: "dataforms-layouts-regular__field", children: fieldDefinition.readOnly === true ? /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(import_jsx_runtime67.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime67.jsxs)(import_jsx_runtime67.Fragment, { children: [
    !hideLabelFromVision && labelPosition !== "none" && /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(import_components20.BaseControl.VisualLabel, { children: fieldDefinition.label }),
    /* @__PURE__ */ (0, import_jsx_runtime67.jsx)(
      fieldDefinition.render,
      {
        item: data,
...
function getLabelContent(showError, errorMessage, fieldLabel) {
  return showError ? /* @__PURE__ */ (0, import_jsx_runtime68.jsxs)(tooltip_exports.Root, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(
      tooltip_exports.Trigger,
      {
        render: /* @__PURE__ */ (0, import_jsx_runtime68.jsxs)("span", { className: "dataforms-layouts-panel__field-label-error-content", children: [
          /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(import_components21.Icon, { icon: error_default, size: 16 }),
          /* @__PURE__ */ (0, import_jsx_runtime68.jsxs)(VisuallyHidden, { children: [
            errorMessage,
            ": "
          ] }),
          fieldLabel
    ...
    /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(tooltip_exports.Popup, { children: errorMessage })
  ] }) : fieldLabel;
}
...
function SummaryButton({
  ...
  const ariaLabel = showError ? (0, import_i18n16.sprintf)(
    // translators: %s: Field name.
    (0, import_i18n16._x)("Edit %s (has errors)", "field"),
    fieldLabel || ""
  ) : (0, import_i18n16.sprintf)(
    // translators: %s: Field name.
    (0, import_i18n16._x)("Edit %s", "field"),
    fieldLabel || ""
  );
  const rowRef = (0, import_element53.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime69.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        labelPosition === "none" && showError && /* @__PURE__ */ (0, import_jsx_runtime69.jsxs)(tooltip_exports.Root, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(
            tooltip_exports.Trigger,
            {
              render: /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(
                "span",
                {
                  className: "dataforms-layouts-panel__field-label-error-content",
                  role: "img",
                  "aria-label": errorMessage,
                  children: /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(import_components22.Icon, { icon: error_default, size: 16 })
                }
              )
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(tooltip_exports.Popup, { children: errorMessage })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(
          "span",
          {
...
function handleElementsValidationAsync(promise, formField, promiseHandler) {
  ...
  promise.then((result) => {
      ...
      setFormValidity((prev) => {
        const newFormValidity = setValidityAtPath(
          prev,
          {
            elements: {
              type: "invalid",
              message: (0, import_i18n17.__)("Could not validate elements.")
            }
          },
          [...path, formField.id]
        );
    ...
    if (error2 instanceof Error) {
      ...
      errorMessage = String(error2) || (0, import_i18n17.__)(
    ...
    setFormValidity((prev) => {
      const newFormValidity = setValidityAtPath(
        prev,
        {
          custom: {
            type: "invalid",
            message: (0, import_i18n17.__)("Validation could not be processed.")
          }
        },
        [...path, formField.id]
      );
...
function validateFormField(item, formField, promiseHandler) {
  ...
  if (formField.field?.isValid.pattern && !formField.field.isValid.pattern.validate(item, formField.field)) {
    return {
      pattern: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value does not match the required pattern.")
      }
    };
  }
  if (formField.field?.isValid.min && !formField.field.isValid.min.validate(item, formField.field)) {
    return {
      min: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value is below the minimum.")
      }
    };
  }
  if (formField.field?.isValid.max && !formField.field.isValid.max.validate(item, formField.field)) {
    return {
      max: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value is above the maximum.")
      }
    };
  }
  if (formField.field?.isValid.minLength && !formField.field.isValid.minLength.validate(item, formField.field)) {
    return {
      minLength: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value is too short.")
      }
    };
  }
  if (formField.field?.isValid.maxLength && !formField.field.isValid.maxLength.validate(item, formField.field)) {
    return {
      maxLength: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value is too long.")
      }
    };
  }
  if (formField.field?.isValid.elements && formField.field.hasElements && !formField.field.getElements && Array.isArray(formField.field.elements) && !formField.field.isValid.elements.validate(item, formField.field)) {
    return {
      elements: {
        type: "invalid",
        message: (0, import_i18n17.__)("Value must be one of the elements.")
      }
    };
  }
  let customError;
  if (!!formField.field && formField.field.isValid.custom) {
    try {
      ...
      if (error2 instanceof Error) {
        ...
        errorMessage = String(error2) || (0, import_i18n17.__)("Unknown error when running custom validation.");
      }
      return {
        custom: {
          type: "invalid",
  ...
  if (!!formField.field && formField.field.isValid.elements && formField.field.hasElements && typeof formField.field.getElements === "function") {
    ...
    fieldValidity.elements = {
      type: "validating",
      message: (0, import_i18n17.__)("Validating\u2026")
    };
  }
...
function useFormValidity(item, fields, form) {
  const [formValidity, setFormValidity] = (0, import_element54.useState)();
  const customCounterRef = (0, import_element54.useRef)({});
  const elementsCounterRef = (0, import_element54.useRef)({});
  const previousValuesRef = (0, import_element54.useRef)({});
  const validate = (0, import_element54.useCallback)(() => {
...
function useFieldFromFormField(field) {
  const { fields } = (0, import_element56.useContext)(dataform_context_default);
  const layout = field.layout;
...
function ModalContent({
  ...
  const { fields } = (0, import_element57.useContext)(dataform_context_default);
  const [changes, setChanges] = (0, import_element57.useState)({});
  const modalData = (0, import_element57.useMemo)(() => {
    return (0, import_deepmerge2.default)(data, changes, {
      arrayMerge: (target, source) => source
    });
  }, [data, changes]);
  const form = (0, import_element57.useMemo)(
    () => ({
      layout: DEFAULT_LAYOUT,
      fields: !!field.children ? field.children : (
  ...
  const contentRef = (0, import_element57.useRef)(null);
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime70.jsxs)(
          Stack,
          {
            ...
            gap: "md",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(import_components23.__experimentalSpacer, { style: { flex: 1 } }),
...
function PanelModal({
  ...
  const [touched, setTouched] = (0, import_element57.useState)(false);
  const [isOpen, setIsOpen] = (0, import_element57.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(
    Stack,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime71.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", children: [
        title && /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(import_components24.__experimentalHeading, { level: 2, size: 13, children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(import_components24.__experimentalSpacer, { style: { flex: 1 } }),
...
function PanelDropdown({
  ...
  const [touched, setTouched] = (0, import_element58.useState)(false);
  const [popoverAnchor, setPopoverAnchor] = (0, import_element58.useState)(
    null
  );
  const popoverProps = (0, import_element58.useMemo)(
    () => ({
  ...
  const form = (0, import_element58.useMemo)(
    () => ({
      layout: DEFAULT_LAYOUT,
      fields: !!field.children ? field.children : (
        // If not explicit children return the field id itself.
  ...
  const formValidity = (0, import_element58.useMemo)(() => {
    if (validity === void 0) {
      return void 0;
    }
    if (!!field.children) {
...
function ValidationBadge({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(Badge, { intent: "high", children: (0, import_i18n19.sprintf)(
...
function HeaderContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)(
    Stack,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(card_exports.Title, { children: label }),
        (hasBadge || hasSummary) && /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)(collapsible_card_exports.HeaderDescription, { className: "dataforms-layouts-card__field-header-content-description", children: [
          hasBadge && /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(ValidationBadge, { validity }),
          hasSummary && /* @__PURE__ */ (0, import_jsx_runtime74.jsx)("div", { className: "dataforms-layouts-card__field-summary", children: visibleSummaryFields.map((summaryField) => /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
            summaryField.render,
            {
              item: data,
              field: summaryField
...
function FormCardField({
  ...
  const { fields } = (0, import_element59.useContext)(dataform_context_default);
  const layout = field.layout;
  const contentRef = (0, import_element59.useRef)(null);
  const form = (0, import_element59.useMemo)(
    () => ({
      layout: DEFAULT_LAYOUT,
      fields: field.children ?? []
    }),
  ...
  const [isOpen, setIsOpen] = (0, import_element59.useState)(isOpened);
  const [touched, setTouched] = (0, import_element59.useState)(false);
  (0, import_element59.useEffect)(() => {
    setIsOpen(isOpened);
  }, [isOpened]);
  const handleOpenChange = (0, import_element59.useCallback)((open) => {
    if (!open) {
      setTouched(true);
    }
    setIsOpen(open);
  }, []);
  const handleBlur = (0, import_element59.useCallback)(() => {
    setTouched(true);
  }, []);
  useReportValidity(
    contentRef,
  ...
  const bodyContent = /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
    BodyContent,
    {
      data,
      field,
  ...
  const headerContent = /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
    HeaderContent,
    {
      data,
      fields,
  ...
  if (withHeader && isCollapsible) {
    return /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)(
      collapsible_card_exports.Root,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(collapsible_card_exports.Header, { children: headerContent }),
          /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)(card_exports.Root, { className: "dataforms-layouts-card__field", children: [
    withHeader && /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(card_exports.Header, { children: headerContent }),
    /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(card_exports.Content, { ref: contentRef, onBlur: handleBlur, children: bodyContent })
  ] });
}
...
function Header5({ title }) {
  return /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(
    Stack,
    {
      ...
      gap: "lg",
      children: /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(Stack, { direction: "row", align: "center", children: /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(import_components25.__experimentalHeading, { level: 2, size: 13, children: title }) })
    }
  );
}
...
function FormRowField({
  ...
  if (!!field.children) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime75.jsxs)("div", { className: "dataforms-layouts-row__field", children: [
      !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(Header5, { title: field.label }),
...
function FormDetailsField({
  ...
  const { fields } = (0, import_element60.useContext)(dataform_context_default);
  const detailsRef = (0, import_element60.useRef)(null);
  const contentRef = (0, import_element60.useRef)(null);
  const [touched, setTouched] = (0, import_element60.useState)(false);
  const [isOpen, setIsOpen] = (0, import_element60.useState)(false);
  const form = (0, import_element60.useMemo)(
    () => ({
      layout: DEFAULT_LAYOUT,
      fields: field.children ?? []
    }),
  ...
  const handleBlur = (0, import_element60.useCallback)(() => {
    setTouched(true);
  }, []);
  if (!field.children) {
    return null;
  ...
  if (summaryField && summaryField.render) {
    ...
    summaryContent = field.label || (0, import_i18n20.__)("More details");
  }
...
function DataFormLayout({
  ...
  const { fields: fieldDefinitions } = (0, import_element61.useContext)(dataform_context_default);
  const markWhenOptional = (0, import_element61.useMemo)(() => {
...
function DataForm({
  ...
  const normalizedForm = (0, import_element62.useMemo)(() => normalize_form_default(form), [form]);
  const normalizedFields = (0, import_element62.useMemo)(
...
function ExperimentsPage() {
  const [experiments, setExperiments] = (0, import_element63.useState)(
    null
  );
  ...
  const gutenbergExperiments = (0, import_element63.useMemo)(
    () => siteSettings?.["gutenberg-experiments"] || {},
    [siteSettings]
  );
  const settings = (0, import_element63.useMemo)(() => {
    const combined = {};
    ...
    try {
      ...
      createSuccessNotice(
        (0, import_i18n21.sprintf)(
          ...
          (0, import_i18n21.__)("%s settings updated."),
          groupLabel
        ),
        { type: "snackbar" }
      );
      ...
      createErrorNotice(
        (0, import_i18n21.sprintf)(
          /* translators: %s: Experiment group name, e.g. "Blocks". */
          (0, import_i18n21.__)("Failed to update %s settings."),
          groupLabel
        ),
        { type: "snackbar" }
      );
  ...
  const formFields = (0, import_element63.useMemo)(() => {
    if (!experiments?.length) {
      return [];
    }
  ...
  if (experiments === null || !siteSettings) {
    return /* @__PURE__ */ React.createElement(import_components26.Spinner, null);
  }
  return /* @__PURE__ */ React.createElement(
    page_default,
    {
      title: (0, import_i18n21.__)("Experimental settings"),
      subTitle: (0, import_i18n21.__)(
