...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'admin-bar', "/wp-includes/js/admin-bar$suffix.js", false, '20110930', 1 );
	...
	if ( is_admin() ) {
		...
		$scripts->add( 'postbox', "/wp-admin/js/postbox$suffix.js", array('jquery-ui-sortable'), '20111008', 1 );
...
function wp_default_styles( &$styles ) {
	...
	$styles->add( 'editor-buttons', "/wp-includes/css/editor-buttons$suffix.css", array(), '20111005' );
