...
function wp_default_styles( &$styles ) {
	...
	$styles->add( 'wp-admin', "/wp-admin/css/wp-admin$suffix.css", array(), '20111106b' );

	$styles->add( 'ie', "/wp-admin/css/ie$suffix.css", array(), '20111015' );
	$styles->add_data( 'ie', 'conditional', 'lte IE 7' );

	// all colors stylesheets need to have the same query strings (cache manifest compat)
	$colors_version = '20111106a';
	...
	$styles->add( 'admin-bar', "/wp-includes/css/admin-bar$suffix.css", array(), '20111106' );
