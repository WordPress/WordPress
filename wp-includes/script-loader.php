...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'wp-fullscreen', "/wp-admin/js/wp-fullscreen$suffix.js", array('jquery'), '20110918', 1 );
	...
	$scripts->add( 'jquery-ui-datepicker', '/wp-includes/js/jquery/ui/jquery.ui.datepicker.min', array('jquery-ui-core'), '1.8.16', 1 );
...
function wp_default_styles( &$styles ) {
	...
	$styles->add( 'wp-admin', "/wp-admin/css/wp-admin$suffix.css", array(), '20110923' );

	$styles->add( 'ie', "/wp-admin/css/ie$suffix.css", array(), '20110919' );
	$styles->add_data( 'ie', 'conditional', 'lte IE 7' );

	// all colors stylesheets need to have the same query strings (cache manifest compat)
	$colors_version = '20110923';
